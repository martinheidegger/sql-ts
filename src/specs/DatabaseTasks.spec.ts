...
`
    ...
    const result = DatabaseTasks.convertDatabaseToTypescript(
      database as any,
      config as any,
    )
...
describe("generateDatabase", () => {
  it("should split into schemas", async () => {
    ...
    const db = {} as Knex
    const mockedGetAllTables = vi
      .mocked(TableTasks.getAllTables)
      .mockResolvedValue(tables)
    const mockedEnumGetAllEnums = vi
      .mocked(EnumTasks.getAllEnums)
      .mockResolvedValue(enums)
